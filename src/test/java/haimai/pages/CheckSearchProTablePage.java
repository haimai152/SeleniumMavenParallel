...
public class CheckSearchProTablePage extends CommonPage {
    ...
    private By searchProButton = By.xpath("//div[@class='input-group-append d-none d-lg-block']//button[@type='submit']");
    ...
    public void checkPageOnSearchProTable(Hashtable<String, String> dataProduct){
       // String searchValue = PropertiesHelpers.getValue("searchProduct");
        ...
        System.out.println("giá trị từ properties file is " + PropertiesHelpers.getValue("itemOnePage"));
        int itemTotalOnePage = Integer.parseInt(PropertiesHelpers.getValue("itemOnePage"));
        System.out.println("Tổng số item / trang: " + itemTotalOnePage);
        int pageTotal= Integer.parseInt(PropertiesHelpers.getValue("pageTotal"));
